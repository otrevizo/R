...
Summary of the log transformed econ indicators
...
The count of countries can be taken by dividing by 20, since each country should have 20 rows/observations (1 for each year)
